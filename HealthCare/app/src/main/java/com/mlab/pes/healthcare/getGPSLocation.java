...
public class getGPSLocation extends ActionBarActivity implements LocationListener{
    ...
    String sid;
    TextView gpsStudentID,latitude,longitude;
    ...
    public void Getback() {
        Intent i = new Intent(this, studentDataEntry.class);
        startActivity(i);
    }
